...
function () {
  ...
  src_createClass(plateNumberInput, [{
    ...
    value: function _generateKeyboard() {
      ...
      setTimeout(function () {
        _this3.keyboardWrapper.innerHTML = combinationRow(currentKeyboard).join('');
      }, 80);
    }
  }, {
    key: "_prefix",
